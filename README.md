...
* Baudrate is back to 115200. 250000 baud is a non-standard baudrate not well handled by some GNU tools and third-party libraries used in the FAB-UI and, apart of that, brings negligible (if none) increase in performance.
